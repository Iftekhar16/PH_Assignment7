...
document.querySelector("#submit").addEventListener("click", () => {
  ...
  let x = setTimeout(() => {
    ...
    displayResult.innerHTML = `<div class="h-[220px] w-[220px] mx-auto mt-8 flex flex-col justify-center border-2 rounded-tr-[50%] rounded-bl-[50%]">
                                ...
                                <p class="text-sm flex justify-center items-center gap-2">Total Time: 
                                  <span class="text-xl text-orange-500">${timeTaken.innerText.replace("sec","")}<span class="text-xs">sec</span>
                                  </span>
                                </p>
                              </div>
